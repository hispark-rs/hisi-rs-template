...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Unreleased` | `hisi-hal` | `0.7.0-alpha.9` | `0.5.10` + `hisi-rtos 0.1.0-alpha.24` | `0.4.0` | `0.1.2` | `hisi-rf 0.1.0-alpha.99` | `hisi-fwpkg-cli 0.3.2` |
| `v0.7.0-alpha.30` | `hisi-hal` | `0.7.0-alpha.9` | `0.5.10` + `hisi-rtos 0.1.0-alpha.24` | `0.4.0` | `0.1.2` | `hisi-rf 0.1.0-alpha.99` | `hisi-fwpkg-cli 0.3.2` |
